...
public class HomeWorkApp04 {
     ...
     */
        ...
        public static int enemyValueMin = 1;
        ...
        public static void roomGameCycle() {
            ...
            while(true) {
                ...
                // прерывание по потере здоровья Врага из за силы Игрока
                //if (!isAttackPlayer()) {
                //    System.out.println("Player has not power");
                //    break;
                //}
        ...
        public static void playerNextMoveAction(int lastPosX, int lastPosY, int nextPosX, int nextPosY) {
            if (invisibleRoom[nextPosY][nextPosX] == enemy) {
                ...
                // моя вставка
                // прерывание по потере здоровья Врага из за силы Игрока, а вообще здесь противоречие мы из здоровья отнимаем силу
               // enemyHP-=playerAttack;
                //
                if ( enemyAttack < playerAttack ) {

                    for (int k = 1; k <= enemyAttack; k++) {

                        System.out.println("Danger!!! Player strikes Enemy!!!! ");
                        }
                ...
                System.out.println( "It's a pity Player has not power" );
        ...
        // прерывание по потере здоровья Врага из за силы Игрока
        //public static boolean isAttackPlayer() {
        //return enemyHP > 0;
        //}
